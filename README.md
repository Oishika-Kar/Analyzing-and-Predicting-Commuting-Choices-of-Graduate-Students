...
In undertaking this project, we draw upon the knowledge and skills acquired through the Industrial Organization course within the MQE program at UCLA, taught by Professor Martin Hackman. While this project is a personal endeavor and not formally associated with coursework, the teachings and concepts learned in the course have significantly influenced our approach and methodology. We extend our gratitude to Professor Hackman for his guidance and insights, which have enriched our understanding of industrial organization principles and enabled us to apply them effectively in this research endeavor on commuting preferences among graduate students. Additionally, we acknowledge the contributions of my colleagues, Kartika Caroline and Reyhand Achmad, whose collaboration and insights have been invaluable throughout the project.
